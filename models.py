...
class BusinessAcquisition(Base):
    """
    Model for business acquisition submissions
    Replaces the old LoLQuestion model with business-focused fields
    """
    __tablename__ = 'business_acquisitions'
    ...
    def __repr__(self):
        return f'<BusinessAcquisition {self.full_name} - ${self.purchase_price:,.0f}>'
